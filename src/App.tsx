...
const defaultCategories: Category[] = [
  {
    ...
    apps: [
      ...
      {
        name: 'Review Trigger',
        description: 'Monitors Airbnb review ratings for competitor listings bi-weekly. Alerts reps via Slack when a rating drops.',
        useCase: 'Get notified when a lead\'s listing review rating drops — that\'s a buying trigger to reach out and start a conversation.',
        url: 'https://lvr-competitor-review-scraper-production.up.railway.app/',
        icon: Star,
      },
      {
        name: 'Marketing Hub',
        description: 'Cross-channel campaign manager for direct mail, Meta ads, and Google Ads with AI optimization.',
        useCase: 'Run and track owner acquisition campaigns across direct mail, Facebook/Instagram, and Google — see performance by market and optimize spend.',
        url: 'https://lvr-direct-mail-hub.vercel.app/',
        icon: Megaphone,
      },
    ],
  },
  {
    ...
    apps: [
      ...
      {
        name: 'Local Sign',
        description: 'Contract signing system. Generates Partner Agreements and Second Home Management contracts from a Salesforce opportunity.',
        useCase: 'Send a branded contract for e-signature in one click from an opportunity. Signed PDF and onboarding fields auto-write back to Salesforce.',
        url: 'https://contracts.golocalvr.com/',
        icon: FileSignature,
      },
      {
        name: 'Sales Home',
  ...
  },
  {
    ...
    apps: [
      ...
      },
      {
        ...
        url: 'https://v2-ui-production.up.railway.app/',
        icon: ChartLine,
      },
      {
        name: 'Recon',
        description: 'Competitor intelligence database. Dossiers on 135+ competitor-market combos across 6 markets with fees, services, and battle cards.',
        useCase: 'Research competitor positioning before a call. See their fee structure, strengths, weaknesses, and how to win against them in a specific market.',
        url: 'https://lvr-recon.vercel.app/',
        icon: Binoculars,
      },
    ],
  },
